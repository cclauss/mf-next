...
"""
translation2po.py
This script is used to translate the {lang}/geoadmin.po-files of CHSDI (more about CHSDI: https://redmine.bgdi.admin.ch/projects/mf-next).

Author: Tobias Reber
Version: 0.7
Usage: /home/ltgal/mf-next/buildout/bin/python translation2po.py /home/ltret/mf-next/geoadmin/i18n/
"""
...
# getting path for the input-file empty_geoadmin.po
try:
    if len(sys.argv) != 2:
         print 'You have to specify the path to the directory i18n containing empty_geoadmin.po'
...
for lang in config["langs"]:
    try:
        file_langjs = open(Path2emptypo + lang + '/LC_MESSAGES/geoadmin.po','w')
    except:
        print "is the path to the directory i18n correct?"
        sys.exit()

    # writing header
    myString = "# " + myLangDict[lang] + " translations for geoadmin.\n"
    myString += "# Copyright (C) 2010 ORGANIZATION\n"
    myString += "# This file is distributed under the same license as the geoadmin project.\n"
    myString += "# FIRST AUTHOR <EMAIL@ADDRESS>, 2010.\n"
    myString += "#\n"
    myString += "msgid \"\"\n"
    myString += "msgstr \"\"\n"
    myString += "\"Project-Id-Version: geoadmin 0.1\\n\"\n"
    ...
    # written
    print 'Translation in ' + myLangDict[lang] + ' accomplished. Verify ' + Path2emptypo + lang + '/LC_MESSAGES/geoadmin.po'
